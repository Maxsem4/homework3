...
function generatePasswordOptions() {
  ...
  if (lengthInput > 128) {
    ...
    let checkforUppercase = confirm (
        'Click OK if utilizing UpperCase'
    )
    console.log(checkforUppercase)
  
    let checkforLowercase = confirm (
      'Click OK if utilizing Lowercase'
  )
  console.log(checkforLowercase)

    let checkforNumber = confirm (
      'Click OK if utilizing Numbers'
    )
  console.log(checkforNumber)

    let checkforSpecial = confirm (
      'Click OK if utilizing Special Characters'
    )
